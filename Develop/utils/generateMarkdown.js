...
else if (licenseBadge === "GNU General Public License v3.0") {
...
else if (licenseBadge === "BSD 2-Clause Simplified License") {
    return "https://img.shields.io/badge/License-BSD_2--Clause-orange.svg"
}

else if (licenseBadge === "BSD 3 Clause New or Revised License") {
...
else if (licenseBadge === "Creative Commons Zero v1.0 Universal") {
  return "https://img.shields.io/badge/License-CC0_1.0-lightgrey.svg"
}

else if (licenseBadge === "Eclipse Public License 1.0") {
  return "https://img.shields.io/badge/License-EPL_1.0-red.svg"
}

else if (licenseBadge === "GNU Affero General Public License v3.0") {
  return "https://img.shields.io/badge/License-AGPL_v3-blue.svg"
}

else if (licenseBadge === "GNU General Public License v2.0") {
  return "https://img.shields.io/badge/License-GPL_v2-blue.svg"
}

else if (licenseBadge === "Mozilla Public License") {
...
https://github.com/${data.Github}/${data.Title}
  ...
  * [Questions](#Questions)
  ...
  # Installation
  The following steps are required to install and/or run this application: ${data.Installation}

  # Usage
  In order to use this application, you must: ${data.Usage}

  # License
  This application falls under the ${data.License}
  ${renderLicenseBadge (data.licenseBadge)}
  ${renderLicenseLink (data.licenseLink)}
  ${renderLicenseSection(data.licenseSection)}

  # Contributing
  The following individual(s) are contributors to this application:${data.Contributing}
